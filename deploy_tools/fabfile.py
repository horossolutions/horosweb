...
REPO_URL = 'https://rowanv@github.com/horossolutions/horosweb.git'
...
def _update_settings(source_folder, site_name):
    settings_path = source_folder + '/webportfolio/settings.py'
    sed(settings_path, "DEBUG = True", "DEBUG = False")  #1
    sed(settings_path,
        'ALLOWED_HOSTS =.+$',
        'ALLOWED_HOSTS = ["%s"]' % (site_name,)  #2
    )
    secret_key_file = source_folder + '/webportfolio/secret_key.py'
